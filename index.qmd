...
Select `Repositories` from the top menu on your dashboard on [github.com](https://github.com). This will take you to another page with a list of your repositories. You can create a single webpage for each repository in GitHub.
...
Update Your remote URL setting in the terminal with this token.
...
your GitHub repository's webpage. You should be on the 'main' branch in GitHub so use the following command.
