...
Leave the `Add .gitignore` and `Add license` fields to the default settings.
...
```{r}
#| label: Use webshot2 to convert the rendered html file to a pdf
#| out-width: "100%"
#| out-height: "900px"
library(webshot2)
webshot2::webshot(url = "docs/index.html", file = "docs/index.pdf")
```
